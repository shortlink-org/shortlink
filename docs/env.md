...
| "GRPC_SERVER_CERT_PATH" | ops/cert/shortlink-server.pem |  |
| "GRPC_SERVER_KEY_PATH" | ops/cert/shortlink-server-key.pem |  |
| "GRPC_CLIENT_PORT" | 50051 |  |
| "GRPC_CLIENT_CERT_PATH" | ops/cert/intermediate_ca.pem |  |
| "STORE_TYPE" | ram | Select: postgres, mongo, mysql, redis, dgraph, sqlite, leveldb, badger, ram, scylla, cassandra |
