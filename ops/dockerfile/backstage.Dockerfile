...
FROM --platform=$BUILDPLATFORM node:21.3-bookworm-slim AS packages
...
FROM --platform=$BUILDPLATFORM node:21.3-bookworm-slim AS build
...
FROM --platform=$TARGETPLATFORM node:21.3-bookworm-slim
