...
gosec: ## Golang security checker
	@docker run --rm -it -v $(pwd):/app -w /app/ securego/gosec -exclude-dir=third_party /app/...

golint: ## Linter for golang
	@docker run --rm -v $(pwd):/app -w /app golangci/golangci-lint:v1.40.1-alpine golangci-lint run ./...
