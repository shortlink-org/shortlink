...
csi-build: ## Build the CSI container
		@echo docker buildx build --platform=linux/amd64,linux/arm64 image ${CI_REGISTRY_IMAGE}-csi:${CI_COMMIT_TAG}
		@docker buildx build --platform=linux/amd64,linux/arm64 --no-cache -t ${CI_REGISTRY_IMAGE}-csi -f ops/dockerfile/csi.Dockerfile .
