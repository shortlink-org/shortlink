...
SHORTLINK_HELM_ADDONS := argocd cert-manager flagger gateway/istio gateway/istio-ingress gateway/nginx-ingress grafana keda knative-operator kyverno metallb prometheus-operator mq/rabbitmq rook-ceph store/postgresql store/redis
