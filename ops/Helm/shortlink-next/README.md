...
string
			...
			<td>
				<div style="max-width: 300px;">
<pre lang="json">
"registry.gitlab.com/shortlink-org/shortlink/ui-next"
</pre>
</div>
			</td>
			<td></td>
...
"64Mi"
		...
		<tr>
			<td id="deploy--securityContext--readOnlyRootFilesystem"><a href="./values.yaml#L66">deploy.securityContext.readOnlyRootFilesystem</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="deploy--volumes[0]--mountPath"><a href="./values.yaml#L70">deploy.volumes[0].mountPath</a></td>
			<td>
string
</td>
			<td>
...
"/tmp"
		...
		<tr>
			<td id="deploy--volumes[0]--name"><a href="./values.yaml#L69">deploy.volumes[0].name</a></td>
			<td>
string
</td>
			<td>
...
"tmp"
		...
		<tr>
			<td id="deploy--volumes[0]--type"><a href="./values.yaml#L71">deploy.volumes[0].type</a></td>
			<td>
string
</td>
			<td>
...
false
		...
		<tr>
			<td id="networkPolicy--ingress[0]--from[0]--namespaceSelector--matchLabels--"kubernetes--io/metadata--name""><a href="./values.yaml#L102">networkPolicy.ingress[0].from[0].namespaceSelector.matchLabels."kubernetes.io/metadata.name"</a></td>
			<td>
string
</td>
			<td>
...
"shortlink"
		...
		<tr>
			<td id="networkPolicy--ingress[0]--from[1]--namespaceSelector--matchLabels--"kubernetes--io/metadata--name""><a href="./values.yaml#L105">networkPolicy.ingress[0].from[1].namespaceSelector.matchLabels."kubernetes.io/metadata.name"</a></td>
			<td>
string
</td>
			<td>
...
"istio-system"
		...
		<tr>
			<td id="networkPolicy--ingress[0]--from[2]--namespaceSelector--matchLabels--"kubernetes--io/metadata--name""><a href="./values.yaml#L108">networkPolicy.ingress[0].from[2].namespaceSelector.matchLabels."kubernetes.io/metadata.name"</a></td>
			<td>
string
</td>
			<td>
...
"nginx-ingress"
		...
		<tr>
			<td id="networkPolicy--ingress[0]--from[3]--namespaceSelector--matchLabels--"kubernetes--io/metadata--name""><a href="./values.yaml#L111">networkPolicy.ingress[0].from[3].namespaceSelector.matchLabels."kubernetes.io/metadata.name"</a></td>
			<td>
string
</td>
			<td>
...
"prometheus-operator"
		...
		<tr>
			<td id="networkPolicy--policyTypes[0]"><a href="./values.yaml#L113">networkPolicy.policyTypes[0]</a></td>
			<td>
string
</td>
			<td>
...
"Ingress"
		...
		<tr>
			<td id="networkPolicy--policyTypes[1]"><a href="./values.yaml#L114">networkPolicy.policyTypes[1]</a></td>
			<td>
string
</td>
			<td>
