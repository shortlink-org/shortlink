...
<table height="400px" >
	...
	<tbody>
		<tr>
			<td id="deploy--annotations"><a href="./values.yaml#L51">deploy.annotations</a></td>
			<td>
object
</td>
			<td>
...
{}
		...
		<tr>
			<td id="deploy--image--pullPolicy"><a href="./values.yaml#L59">deploy.image.pullPolicy</a></td>
			<td>
string
</td>
			<td>
...
"Always"
		...
		<tr>
			<td id="deploy--image--repository"><a href="./values.yaml#L54">deploy.image.repository</a></td>
			<td>
string
</td>
			<td>
...
"registry.gitlab.com/shortlink-org/shortlink/ui-next"
		...
		<tr>
			<td id="deploy--image--tag"><a href="./values.yaml#L55">deploy.image.tag</a></td>
			<td>
string
</td>
			<td>
...
[]
		...
		<tr>
			<td id="deploy--livenessProbe"><a href="./values.yaml#L62">deploy.livenessProbe</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "httpGet": {
    ...
    "port": 8080
		...
		<tr>
			<td id="deploy--readinessProbe"><a href="./values.yaml#L68">deploy.readinessProbe</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  "httpGet": {
    ...
    "port": 8080
		...
		<tr>
			<td id="deploy--replicaCount"><a href="./values.yaml#L38">deploy.replicaCount</a></td>
			<td>
int
</td>
			<td>
...
"64Mi"
		...
		<tr>
			<td id="deploy--securityContext--readOnlyRootFilesystem"><a href="./values.yaml#L74">deploy.securityContext.readOnlyRootFilesystem</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="deploy--volumes[0]--mountPath"><a href="./values.yaml#L78">deploy.volumes[0].mountPath</a></td>
			<td>
string
</td>
			<td>
...
"/tmp"
		...
		<tr>
			<td id="deploy--volumes[0]--name"><a href="./values.yaml#L77">deploy.volumes[0].name</a></td>
			<td>
string
</td>
			<td>
...
"tmp"
		...
		<tr>
			<td id="deploy--volumes[0]--type"><a href="./values.yaml#L79">deploy.volumes[0].type</a></td>
			<td>
string
</td>
			<td>
...
true
		...
		<tr>
			<td id="podDisruptionBudget--enabled"><a href="./values.yaml#L99">podDisruptionBudget.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="service--ports[0]--name"><a href="./values.yaml#L86">service.ports[0].name</a></td>
			<td>
string
</td>
			<td>
...
"http"
		...
		<tr>
			<td id="service--ports[0]--port"><a href="./values.yaml#L87">service.ports[0].port</a></td>
			<td>
int
</td>
			<td>
...
8080
		...
		<tr>
			<td id="service--ports[0]--protocol"><a href="./values.yaml#L88">service.ports[0].protocol</a></td>
			<td>
string
</td>
			<td>
...
"TCP"
		...
		<tr>
			<td id="service--ports[0]--public"><a href="./values.yaml#L89">service.ports[0].public</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="service--type"><a href="./values.yaml#L84">service.type</a></td>
			<td>
string
</td>
			<td>
