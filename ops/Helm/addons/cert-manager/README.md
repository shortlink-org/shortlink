...
|------------|------|---------|
| https://charts.jetstack.io | certmanager(cert-manager) | v1.15.2 |
| https://charts.jetstack.io | cert-manager-approver-policy | v0.15.0 |
| https://charts.jetstack.io | spiffe(cert-manager-csi-driver-spiffe) | v0.8.0 |
