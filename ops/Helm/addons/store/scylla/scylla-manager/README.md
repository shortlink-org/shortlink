...
<table height="400px" >
	...
	<tbody>
		<tr>
			<td id="scylla-manager--enabled"><a href="./values.yaml#L2">scylla-manager.enabled</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="scylla-manager--serviceMonitor--create"><a href="./values.yaml#L5">scylla-manager.serviceMonitor.create</a></td>
			<td>
bool
</td>
			<td>
