...
"cert-manager-production"
		...
		<tr>
			<td id="ingress--annotations--"nginx--ingress--kubernetes--io/enable-opentelemetry""><a href="./values.yaml#L34">ingress.annotations."nginx.ingress.kubernetes.io/enable-opentelemetry"</a></td>
			<td>
string
</td>
			<td>
...
"true"
		...
		<tr>
			<td id="ingress--annotations--"nginx--ingress--kubernetes--io/enable-owasp-core-rules""><a href="./values.yaml#L33">ingress.annotations."nginx.ingress.kubernetes.io/enable-owasp-core-rules"</a></td>
			<td>
string
</td>
			<td>
...
"true"
		...
		<tr>
			<td id="ingress--annotations--"nginx--ingress--kubernetes--io/rewrite-target""><a href="./values.yaml#L35">ingress.annotations."nginx.ingress.kubernetes.io/rewrite-target"</a></td>
			<td>
string
</td>
			<td>
...
"/s/$2"
		...
		<tr>
			<td id="ingress--annotations--"nginx--ingress--kubernetes--io/use-regex""><a href="./values.yaml#L36">ingress.annotations."nginx.ingress.kubernetes.io/use-regex"</a></td>
			<td>
string
</td>
			<td>
...
true
		...
		<tr>
			<td id="ingress--hostname"><a href="./values.yaml#L38">ingress.hostname</a></td>
			<td>
string
</td>
			<td>
...
"shortlink.best"
		...
		<tr>
			<td id="ingress--ingressClassName"><a href="./values.yaml#L30">ingress.ingressClassName</a></td>
			<td>
string
</td>
			<td>
...
"nginx"
		...
		<tr>
			<td id="ingress--paths[0]--path"><a href="./values.yaml#L40">ingress.paths[0].path</a></td>
			<td>
string
</td>
			<td>
...
"/s(/|$)(.*)"
		...
		<tr>
			<td id="ingress--paths[0]--service--name"><a href="./values.yaml#L42">ingress.paths[0].service.name</a></td>
			<td>
string
</td>
			<td>
...
"proxy"
		...
		<tr>
			<td id="ingress--paths[0]--service--port"><a href="./values.yaml#L43">ingress.paths[0].service.port</a></td>
			<td>
int
</td>
			<td>
...
true
		...
		<tr>
			<td id="networkPolicy--enabled"><a href="./values.yaml#L141">networkPolicy.enabled</a></td>
			<td>
bool
</td>
			<td>
...
false
		...
		<tr>
			<td id="networkPolicy--ingress[0]--from[0]--namespaceSelector--matchLabels--"kubernetes--io/metadata--name""><a href="./values.yaml#L147">networkPolicy.ingress[0].from[0].namespaceSelector.matchLabels."kubernetes.io/metadata.name"</a></td>
			<td>
string
</td>
			<td>
...
"shortlink"
		...
		<tr>
			<td id="networkPolicy--ingress[0]--from[1]--namespaceSelector--matchLabels--"kubernetes--io/metadata--name""><a href="./values.yaml#L150">networkPolicy.ingress[0].from[1].namespaceSelector.matchLabels."kubernetes.io/metadata.name"</a></td>
			<td>
string
</td>
			<td>
...
"istio-system"
		...
		<tr>
			<td id="networkPolicy--ingress[0]--from[2]--namespaceSelector--matchLabels--"kubernetes--io/metadata--name""><a href="./values.yaml#L153">networkPolicy.ingress[0].from[2].namespaceSelector.matchLabels."kubernetes.io/metadata.name"</a></td>
			<td>
string
</td>
			<td>
...
"istio-ingress"
		...
		<tr>
			<td id="networkPolicy--ingress[0]--from[3]--namespaceSelector--matchLabels--"kubernetes--io/metadata--name""><a href="./values.yaml#L156">networkPolicy.ingress[0].from[3].namespaceSelector.matchLabels."kubernetes.io/metadata.name"</a></td>
			<td>
string
</td>
			<td>
...
"prometheus-operator"
		...
		<tr>
			<td id="networkPolicy--ingress[0]--from[4]--namespaceSelector--matchLabels--"kubernetes--io/metadata--name""><a href="./values.yaml#L159">networkPolicy.ingress[0].from[4].namespaceSelector.matchLabels."kubernetes.io/metadata.name"</a></td>
			<td>
string
</td>
			<td>
...
"grafana"
		...
		<tr>
			<td id="networkPolicy--policyTypes[0]"><a href="./values.yaml#L161">networkPolicy.policyTypes[0]</a></td>
			<td>
string
</td>
			<td>
...
"Ingress"
		...
		<tr>
			<td id="networkPolicy--policyTypes[1]"><a href="./values.yaml#L162">networkPolicy.policyTypes[1]</a></td>
			<td>
string
</td>
			<td>
