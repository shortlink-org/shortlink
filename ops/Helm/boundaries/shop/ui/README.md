...
1
		...
		<tr>
			<td id="deploy--resources--limits--cpu"><a href="./values.yaml#L34">deploy.resources.limits.cpu</a></td>
			<td>
string
</td>
			<td>
...
"100m"
		...
		<tr>
			<td id="deploy--resources--limits--memory"><a href="./values.yaml#L35">deploy.resources.limits.memory</a></td>
			<td>
string
</td>
			<td>
...
"128Mi"
		...
		<tr>
			<td id="deploy--resources--requests--cpu"><a href="./values.yaml#L37">deploy.resources.requests.cpu</a></td>
			<td>
string
</td>
			<td>
...
"15m"
		...
		<tr>
			<td id="deploy--resources--requests--memory"><a href="./values.yaml#L38">deploy.resources.requests.memory</a></td>
			<td>
string
</td>
			<td>
