...
<table height="400px" >
	...
	<tbody>
		<tr>
			<td id="NetworkPolicy--enabled"><a href="./values.yaml#L105">NetworkPolicy.enabled</a></td>
			<td>
bool
</td>
			<td>
...
30
		...
		<tr>
			<td id="deploy--strategy--canary--steps[1]--pause--duration"><a href="./values.yaml#L42">deploy.strategy.canary.steps[1].pause.duration</a></td>
			<td>
int
</td>
			<td>
...
10
		...
		<tr>
			<td id="deploy--strategy--canary--steps[2]--setWeight"><a href="./values.yaml#L43">deploy.strategy.canary.steps[2].setWeight</a></td>
			<td>
int
</td>
			<td>
...
60
		...
		<tr>
			<td id="deploy--strategy--canary--steps[3]--pause--duration"><a href="./values.yaml#L45">deploy.strategy.canary.steps[3].pause.duration</a></td>
			<td>
int
</td>
			<td>
...
10
		...
		<tr>
			<td id="deploy--strategy--canary--steps[4]--setWeight"><a href="./values.yaml#L46">deploy.strategy.canary.steps[4].setWeight</a></td>
			<td>
int
</td>
			<td>
...
100
		...
		<tr>
			<td id="deploy--strategy--canary--steps[5]--pause--duration"><a href="./values.yaml#L48">deploy.strategy.canary.steps[5].pause.duration</a></td>
			<td>
int
</td>
			<td>
...
"Rollout"
		...
		<tr>
			<td id="external_database"><a href="./values.yaml#L129">external_database</a></td>
			<td>
object
</td>
			<td>
...
"ContainerResource"
		...
		<tr>
			<td id="hpa--metrics[1]--external--metric--name"><a href="./values.yaml#L99">hpa.metrics[1].external.metric.name</a></td>
			<td>
string
</td>
			<td>
...
"http_server_response_content_length_total"
		...
		<tr>
			<td id="hpa--metrics[1]--external--target--averageValue"><a href="./values.yaml#L102">hpa.metrics[1].external.target.averageValue</a></td>
			<td>
int
</td>
			<td>
...
100
		...
		<tr>
			<td id="hpa--metrics[1]--external--target--type"><a href="./values.yaml#L101">hpa.metrics[1].external.target.type</a></td>
			<td>
string
</td>
			<td>
...
"AverageValue"
		...
		<tr>
			<td id="hpa--metrics[1]--type"><a href="./values.yaml#L96">hpa.metrics[1].type</a></td>
			<td>
string
</td>
			<td>
...
false
		...
		<tr>
			<td id="service--ports[0]--name"><a href="./values.yaml#L110">service.ports[0].name</a></td>
			<td>
string
</td>
			<td>
...
"http"
		...
		<tr>
			<td id="service--ports[0]--port"><a href="./values.yaml#L111">service.ports[0].port</a></td>
			<td>
int
</td>
			<td>
...
7070
		...
		<tr>
			<td id="service--ports[0]--protocol"><a href="./values.yaml#L112">service.ports[0].protocol</a></td>
			<td>
string
</td>
			<td>
...
"TCP"
		...
		<tr>
			<td id="service--ports[0]--public"><a href="./values.yaml#L113">service.ports[0].public</a></td>
			<td>
bool
</td>
			<td>
...
true
		...
		<tr>
			<td id="service--ports[1]--name"><a href="./values.yaml#L114">service.ports[1].name</a></td>
			<td>
string
</td>
			<td>
...
"metrics"
		...
		<tr>
			<td id="service--ports[1]--port"><a href="./values.yaml#L115">service.ports[1].port</a></td>
			<td>
int
</td>
			<td>
...
9090
		...
		<tr>
			<td id="service--ports[1]--protocol"><a href="./values.yaml#L116">service.ports[1].protocol</a></td>
			<td>
string
</td>
			<td>
...
"TCP"
		...
		<tr>
			<td id="service--type"><a href="./values.yaml#L108">service.type</a></td>
			<td>
string
</td>
			<td>
