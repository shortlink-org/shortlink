...
<table height="400px" >
	...
	<tbody>
		<tr>
			<td id="deploy--env--LOGIN_URL"><a href="./values.yaml#L44">deploy.env.LOGIN_URL</a></td>
			<td>
string
</td>
			<td>
...
"https://shortlink.best/next/auth/login"
		...
		<tr>
			<td id="deploy--env--ORY_SDK_URL"><a href="./values.yaml#L42">deploy.env.ORY_SDK_URL</a></td>
			<td>
string
</td>
			<td>
...
"https://shortlink.best/api/auth"
		...
		<tr>
			<td id="deploy--env--ORY_UI_URL"><a href="./values.yaml#L43">deploy.env.ORY_UI_URL</a></td>
			<td>
string
</td>
			<td>
...
<pre lang="json">
{
  ...
  "initialDelaySeconds": 30
		...
		<tr>
			<td id="deploy--resources--limits"><a href="./values.yaml#L82">deploy.resources.limits</a></td>
			<td>
object
</td>
			<td>
...
<pre lang="json">
{
  ...
  "memory": "128Mi"
		...
		<tr>
			<td id="deploy--resources--requests--cpu"><a href="./values.yaml#L86">deploy.resources.requests.cpu</a></td>
			<td>
string
</td>
			<td>
...
"10m"
		...
		<tr>
			<td id="deploy--resources--requests--memory"><a href="./values.yaml#L87">deploy.resources.requests.memory</a></td>
			<td>
string
</td>
			<td>
...
<pre lang="json">
{
  ...
  "runAsUser": 1000
		...
		<tr>
			<td id="deploy--startupProbe"><a href="./values.yaml#L55">deploy.startupProbe</a></td>
			<td>
object
</td>
			<td>
