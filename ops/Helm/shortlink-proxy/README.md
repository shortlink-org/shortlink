...
| deploy.readinessProbe | object | `{"failureThreshold":30,"httpGet":{"path":"/ready","port":3020},"initialDelaySeconds":5,"periodSeconds":5,"successThreshold":1}` | define a readiness probe that checks every 5 seconds, starting after 5 seconds |
