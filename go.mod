...
require (
	...
	github.com/grafana/pyroscope-go v1.0.5-0.20240111051138-ea43ed9e27a3
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.46.2-0.20240108170736-3cecdcf33c47
