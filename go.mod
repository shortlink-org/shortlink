...
require (
	...
	github.com/grafana/pyroscope-go v1.0.5-0.20240119185849-dc747716a54c
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.46.2-0.20240118085743-a28c68ba9b90
