...
require (
	...
	github.com/edgedb/edgedb-go v0.15.1
...
replace (
	...
	k8s.io/apiextensions-apiserver => k8s.io/apiextensions-apiserver v0.30.0-alpha.3
	...
	k8s.io/dynamic-resource-allocation => k8s.io/dynamic-resource-allocation v0.30.0-alpha.3
	k8s.io/endpointslice => k8s.io/endpointslice v0.30.0-alpha.3
	k8s.io/kms => k8s.io/kms v0.30.0-alpha.3
	k8s.io/kube-aggregator => k8s.io/kube-aggregator v0.30.0-alpha.3
	k8s.io/kube-controller-manager => k8s.io/kube-controller-manager v0.30.0-alpha.3
	k8s.io/kube-proxy => k8s.io/kube-proxy v0.30.0-alpha.3
	k8s.io/kube-scheduler => k8s.io/kube-scheduler v0.30.0-alpha.3
	k8s.io/kubectl => k8s.io/kubectl v0.30.0-alpha.3
	k8s.io/kubelet => k8s.io/kubelet v0.30.0-alpha.3
	k8s.io/legacy-cloud-providers => k8s.io/legacy-cloud-providers v0.30.0-alpha.3
	k8s.io/metrics => k8s.io/metrics v0.30.0-alpha.3
	k8s.io/mount-utils => k8s.io/mount-utils v0.30.0-alpha.3
	k8s.io/pod-security-admission => k8s.io/pod-security-admission v0.30.0-alpha.3
	k8s.io/sample-apiserver => k8s.io/sample-apiserver v0.30.0-alpha.3
)
