export default function SocialAuth() {
  return (
    <div className="grid grid-cols-3 gap-x-3">
      <button className="flex-none flex items-center justify-center h-9 rounded-md text-gray-500 hover:text-gray-600 border border-gray-300 hover:border-gray-400" type="button" aria-label="like">
