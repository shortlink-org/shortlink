...
export function BillingContent() {
  return (
    <React.Fragment>
      ...
      <div className="relative inline-block text-left flex flex-wrap content-center">
        <div
          className="flex flex-wrap content-center z-10 ml-4 mt-3 transform px-2 w-screen max-w-md">
          <div className="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 overflow-hidden">
            <div
              ...
              <a href="#" className="-m-3 p-3 flex items-center hover:bg-gray-50">
                <svg width="20" height="20" fill="currentColor" className="dark:text-white flex-shrink-0 h-6 w-6 mr-2"
                     viewBox="0 0 2304 1792" xmlns="http://www.w3.org/2000/svg">
                  <path
