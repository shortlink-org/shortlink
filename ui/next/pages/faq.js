      ...
      <dl className="w-full md:w-2/3">
        ...
        <dd className="mb-16">
          <p>
            ...
            valohai.yaml configuration file. Moving projects in and out of Valohai is easy – the integration is only the
            configuration file.
          </p>
        </dd>
        <dt className="mb-4">
        ...
        <dd className="mb-16">
          <p>
            ...
            Valohai doesn&#x27;t charge anything on top of the per-user license fee. If you don&#x27;t have a cloud
...
export default function FAQ() {
  return <Layout content={FAQPageContent} />;
}
