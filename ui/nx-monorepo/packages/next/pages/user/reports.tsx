      ...
      <div className="px-4 py-4 my-3 rounded mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-14 lg:px-8 lg:py-10 bg-white dark:bg-gray-800">
        <div className="flex flex-col">
          <p className="text-gray-800 dark:text-gray-300">
            ...
            include things like how many people clicked on your links, where
            they came from, and what kind of device they were using. This
            information can be extremely valuable in understanding your audience
            and tailoring your content to them. Additionally, we can customize
            the reports to include only the information that you are interested
            in. Our reporting system is designed to be flexible and
            user-friendly, so you can get the most out of it.
          </p>
