      ...
      <div className="text">
        ...
        <article className="prose dark:prose-invert">
          <p className="text-gray-700">
            ...
            collaborate online. We believe that communication should be easy
            and accessible for everyone, and our mission is to make sure
            that's always the case. With shortlink, sharing content and
            collaborating with others is more convenient than ever before.
          </p>
          ...
          <p className="text-gray-700">
            ...
            to help as many people as possible and become market leaders in
            the process.
          </p>

          <p className="text-gray-700">
            If you're looking for the best possible solution, look no further
            than shortlink. Try it today and see for yourself how easy it is
            to find the best practices and follow them.
          </p>
        </article>
      </div>
    </div>
