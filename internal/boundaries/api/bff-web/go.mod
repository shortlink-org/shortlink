...
require (
	...
	github.com/grafana/pyroscope-go v1.0.5-0.20240116072722-105400ca5ce2 // indirect
	...
	go.opentelemetry.io/contrib/instrumentation/google.golang.org/grpc/otelgrpc v0.46.2-0.20240116183556-96790b3addf6 // indirect
