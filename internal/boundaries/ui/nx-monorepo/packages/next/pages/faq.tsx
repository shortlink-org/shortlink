            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  it's perfect for when you want to post a link on social media
                  or in an email. Plus, it's free to use!
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  use it as much as you want, for as long as you want. We'll
                  never ask for your payment information or try to upsell you on
                  any features.
                </p>
              </div>
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  security of our users' data very seriously. We have
                  implemented multiple layers of security to protect users'
                  data, and we will never share user data with any third party
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  everyone. There are no catches or gimmicks. We want everyone
                  to be able to use this product and get the most out of it.
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  We also have outstanding customer support. If you ever have
                  any questions or problems, our team is always happy to help.
              ...
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  instructions on how to do so, please consult the readme or
                  read the docs.
                </p>
              </div>
            </div>
