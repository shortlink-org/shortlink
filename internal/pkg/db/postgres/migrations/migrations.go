...
func migrations_testGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "migrations_test.go", size: 870, mode: os.FileMode(436), modTime: time.Unix(1611628629, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
