...
type UnitOfWork_Expecter[T any] struct {
	mock *mock.Mock
}
...
type UnitOfWork_Commit_Call[T any] struct {
	*mock.Call
}

// Commit is a helper method to define mock.On call
//   - ctx context.Context
func (_e *UnitOfWork_Expecter[T]) Commit(ctx any) *UnitOfWork_Commit_Call[T] {
...
type UnitOfWork_RegisterClean_Call[T any] struct {
	*mock.Call
}

// RegisterClean is a helper method to define mock.On call
//   - in ...T
func (_e *UnitOfWork_Expecter[T]) RegisterClean(in ...any) *UnitOfWork_RegisterClean_Call[T] {
...
type UnitOfWork_RegisterDeleted_Call[T any] struct {
	*mock.Call
}

// RegisterDeleted is a helper method to define mock.On call
//   - in ...T
func (_e *UnitOfWork_Expecter[T]) RegisterDeleted(in ...any) *UnitOfWork_RegisterDeleted_Call[T] {
...
type UnitOfWork_RegisterDirty_Call[T any] struct {
	*mock.Call
}

// RegisterDirty is a helper method to define mock.On call
//   - in ...T
func (_e *UnitOfWork_Expecter[T]) RegisterDirty(in ...any) *UnitOfWork_RegisterDirty_Call[T] {
...
type UnitOfWork_RegisterNew_Call[T any] struct {
	*mock.Call
}

// RegisterNew is a helper method to define mock.On call
//   - in ...T
func (_e *UnitOfWork_Expecter[T]) RegisterNew(in ...any) *UnitOfWork_RegisterNew_Call[T] {
...
type UnitOfWork_Rollback_Call[T any] struct {
	*mock.Call
}

// Rollback is a helper method to define mock.On call
//   - ctx context.Context
func (_e *UnitOfWork_Expecter[T]) Rollback(ctx any) *UnitOfWork_Rollback_Call[T] {
...
func NewUnitOfWork[T any](t interface {
	mock.TestingT
	Cleanup(func())
}) *UnitOfWork[T] {
	mock := &UnitOfWork[T]{}
