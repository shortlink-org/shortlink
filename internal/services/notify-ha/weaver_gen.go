...
func init() {
	codegen.Register(codegen.Registration{
		...
		RefData: "⟦832b2257:wEaVeReDgE:github.com/ServiceWeaver/weaver/Main→github.com/shortlink-org/shortlink/internal/services/notify-ha/Reverser⟧\n⟦17f36ff9:wEaVeRlIsTeNeRs:github.com/ServiceWeaver/weaver/Main→hello⟧\n",
	})
	codegen.Register(codegen.Registration{
		Name:  "github.com/shortlink-org/shortlink/internal/services/notify-ha/Reverser",
		...
		ClientStubFn: func(stub codegen.Stub, caller string) any {
			return reverser_client_stub{stub: stub, reverseMetrics: codegen.MethodMetricsFor(codegen.MethodLabels{Caller: caller, Component: "github.com/shortlink-org/shortlink/internal/services/notify-ha/Reverser", Method: "Reverse"})}
		},
		ServerStubFn: func(impl any, addLoad func(uint64, float64)) codegen.Server {
