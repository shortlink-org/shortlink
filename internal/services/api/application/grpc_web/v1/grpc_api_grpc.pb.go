...
const (
	LinkService_GetLinks_FullMethodName   = "/grpc_web.v1.LinkService/GetLinks"
	LinkService_GetLink_FullMethodName    = "/grpc_web.v1.LinkService/GetLink"
	LinkService_CreateLink_FullMethodName = "/grpc_web.v1.LinkService/CreateLink"
	LinkService_DeleteLink_FullMethodName = "/grpc_web.v1.LinkService/DeleteLink"
)
...
func (c *linkServiceClient) GetLinks(ctx context.Context, in *GetLinksRequest, opts ...grpc.CallOption) (*GetLinksResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkService_GetLinks_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
