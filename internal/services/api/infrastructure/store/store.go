...
import (
	...
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/badger"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/cassandra"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/dgraph"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/leveldb"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/mongo"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/mysql"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/postgres"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/query"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/ram"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/redis"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/rethinkdb" // nolint staticcheck
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/scylla"
	"github.com/batazor/shortlink/internal/services/api/infrastructure/store/sqlite"
