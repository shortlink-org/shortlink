...
interface ILinkQueryServiceService_IList extends grpc.MethodDefinition<infrastructure_rpc_cqrs_link_v1_link_query_pb.ListRequest, infrastructure_rpc_cqrs_link_v1_link_query_pb.ListResponse> {
    path: "/infrastructure.rpc.cqrs.link.v1.LinkQueryService/List";
    requestStream: false;
    responseStream: false;
    requestSerialize: grpc.serialize<infrastructure_rpc_cqrs_link_v1_link_query_pb.ListRequest>;
    requestDeserialize: grpc.deserialize<infrastructure_rpc_cqrs_link_v1_link_query_pb.ListRequest>;
    responseSerialize: grpc.serialize<infrastructure_rpc_cqrs_link_v1_link_query_pb.ListResponse>;
    responseDeserialize: grpc.deserialize<infrastructure_rpc_cqrs_link_v1_link_query_pb.ListResponse>;
}
...
export interface ILinkQueryServiceServer extends grpc.UntypedServiceImplementation {
    ...
    list: grpc.handleUnaryCall<infrastructure_rpc_cqrs_link_v1_link_query_pb.ListRequest, infrastructure_rpc_cqrs_link_v1_link_query_pb.ListResponse>;
}
...
export interface ILinkQueryServiceClient {
    ...
    list(request: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListRequest, callback: (error: grpc.ServiceError | null, response: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListResponse) => void): grpc.ClientUnaryCall;
    list(request: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListResponse) => void): grpc.ClientUnaryCall;
    list(request: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListResponse) => void): grpc.ClientUnaryCall;
}
...
export class LinkQueryServiceClient extends grpc.Client implements ILinkQueryServiceClient {
    ...
    public list(request: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListRequest, callback: (error: grpc.ServiceError | null, response: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListResponse) => void): grpc.ClientUnaryCall;
    public list(request: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListRequest, metadata: grpc.Metadata, callback: (error: grpc.ServiceError | null, response: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListResponse) => void): grpc.ClientUnaryCall;
    public list(request: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListRequest, metadata: grpc.Metadata, options: Partial<grpc.CallOptions>, callback: (error: grpc.ServiceError | null, response: infrastructure_rpc_cqrs_link_v1_link_query_pb.ListResponse) => void): grpc.ClientUnaryCall;
}
