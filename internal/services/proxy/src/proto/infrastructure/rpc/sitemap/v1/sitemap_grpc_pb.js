...
var infrastructure_rpc_sitemap_v1_sitemap_pb = require('../../../../infrastructure/rpc/sitemap/v1/sitemap_pb.js');
...
function serialize_infrastructure_rpc_sitemap_v1_ParseRequest(arg) {
  if (!(arg instanceof infrastructure_rpc_sitemap_v1_sitemap_pb.ParseRequest)) {
...
function deserialize_infrastructure_rpc_sitemap_v1_ParseRequest(buffer_arg) {
  return infrastructure_rpc_sitemap_v1_sitemap_pb.ParseRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var SitemapServiceService = exports.SitemapServiceService = {
  parse: {
    ...
    requestType: infrastructure_rpc_sitemap_v1_sitemap_pb.ParseRequest,
