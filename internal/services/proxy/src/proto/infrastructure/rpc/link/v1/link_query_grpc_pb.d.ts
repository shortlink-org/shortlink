...
interface ILinkQueryServiceService_IGet extends grpc.MethodDefinition<infrastructure_rpc_link_v1_link_pb.GetRequest, infrastructure_rpc_link_v1_link_pb.GetResponse> {
