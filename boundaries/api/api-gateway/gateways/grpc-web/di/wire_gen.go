...
func InitializeAPIService() (*APIService, func(), error) {
	...
	api, err := NewAPIApplication(context, logger, server, tracerProvider, monitoring, linkServiceClient, linkCommandServiceClient, linkQueryServiceClient, sitemapServiceClient)
	if err != nil {
		cleanup6()
		cleanup5()
		cleanup4()
...
// APIService ==========================================================================================================
var APISet = wire.NewSet(di.DefaultSet, permission.New, rpc.InitServer, NewRPCClient,
