...
require (
	...
	github.com/shortlink-org/shortlink v0.0.0-20240207201015-73f15ba06b45
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/mongo/otelmongo v0.48.0 // indirect
