...
pub mod newsletter_service_client {
    ...
    impl NewsletterServiceClient<tonic::transport::Channel> {
    ...
    impl<T> NewsletterServiceClient<T>
    where
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> NewsletterServiceClient<InterceptedService<T, F>>
        where
        ...
        {
            NewsletterServiceClient::new(InterceptedService::new(inner, interceptor))
        }
        ...
        pub async fn subscribe(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/infrastructure.rpc.newsletter.v1.NewsletterService/Subscribe",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn un_subscribe(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/infrastructure.rpc.newsletter.v1.NewsletterService/UnSubscribe",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod newsletter_service_server {
    #![allow(unused_variables, dead_code, missing_docs, clippy::let_unit_value)]
    use tonic::codegen::*;
    ...
    impl<T: NewsletterService> NewsletterServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for NewsletterServiceServer<T>
    where
        T: NewsletterService,
        B: Body + Send + 'static,
        B::Error: Into<StdError> + Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/infrastructure.rpc.newsletter.v1.NewsletterService/Subscribe" => {
                    #[allow(non_camel_case_types)]
                    struct SubscribeSvc<T: NewsletterService>(pub Arc<T>);
                    impl<
                        T: NewsletterService,
                    ...
                    for SubscribeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NewsletterService>::subscribe(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/infrastructure.rpc.newsletter.v1.NewsletterService/UnSubscribe" => {
                    #[allow(non_camel_case_types)]
                    struct UnSubscribeSvc<T: NewsletterService>(pub Arc<T>);
                    impl<
                        T: NewsletterService,
                    ...
                    for UnSubscribeSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as NewsletterService>::un_subscribe(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T: NewsletterService> Clone for NewsletterServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    impl<T: NewsletterService> tonic::server::NamedService
    for NewsletterServiceServer<T> {
        const NAME: &'static str = "infrastructure.rpc.newsletter.v1.NewsletterService";
    }
}
