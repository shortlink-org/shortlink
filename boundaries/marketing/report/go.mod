...
require (
	...
	github.com/shortlink-org/shortlink v0.0.0-20240627160726-8b4e787cf33b
...
require (
	...
	github.com/neo4j/neo4j-go-driver/v5 v5.21.0 // indirect
	github.com/ory/client-go v1.11.12 // indirect
