...
func (f *FilterLink) BuildRAMFilter(item any) bool {
	var fieldVal *StringFilterInput
	var ok bool
	var v reflect.Value

	fieldVal, ok = reflect.ValueOf(f).Elem().FieldByName("FieldMask").Interface().(*StringFilterInput)
	if !ok || fieldVal == nil {
		return true
	...
	fieldVal, ok = reflect.ValueOf(f).Elem().FieldByName("Url").Interface().(*StringFilterInput)
	if !ok || fieldVal == nil {
		return true
	} // If field is not found or nil, no filtering is applied
	...
	fieldVal, ok = reflect.ValueOf(f).Elem().FieldByName("Hash").Interface().(*StringFilterInput)
	if !ok || fieldVal == nil {
		return true
	} // If field is not found or nil, no filtering is applied
	...
	fieldVal, ok = reflect.ValueOf(f).Elem().FieldByName("Describe").Interface().(*StringFilterInput)
	if !ok || fieldVal == nil {
		return true
	} // If field is not found or nil, no filtering is applied
	...
	fieldVal, ok = reflect.ValueOf(f).Elem().FieldByName("CreatedAt").Interface().(*StringFilterInput)
	if !ok || fieldVal == nil {
		return true
	} // If field is not found or nil, no filtering is applied
	...
	fieldVal, ok = reflect.ValueOf(f).Elem().FieldByName("UpdatedAt").Interface().(*StringFilterInput)
	if !ok || fieldVal == nil {
		return true
	} // If field is not found or nil, no filtering is applied
