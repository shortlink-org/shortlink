...
require (
	...
	buf.build/gen/go/shortlink-org/shortlink-link-link/protocolbuffers/go v1.36.3-20240420204150-bbba30c24796.1
...
require (
	...
	github.com/authzed/authzed-go v1.2.1 // indirect
	...
	github.com/ory/client-go v1.15.17 // indirect
