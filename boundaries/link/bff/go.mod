...
require (
	...
	github.com/shortlink-org/shortlink v0.0.0-20240424154442-435e4d53a5d3
...
require (
	...
	go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver/mongo/otelmongo v0.50.0 // indirect
