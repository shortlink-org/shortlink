...
const de_DEData string = "\x02BFF Web läuft auf Port %[1]d"
...
const fr_CHData string = "\x02BFF Web run on port %[1]d"

// Total table size 178 bytes (0KiB); checksum: 8D68F083
