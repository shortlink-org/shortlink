...
func (c *linkQueryServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	...
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, LinkQueryService_Get_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *linkQueryServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, LinkQueryService_List_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedLinkQueryServiceServer must be embedded to have
...
func (UnimplementedLinkQueryServiceServer) testEmbeddedByValue()                          {}
...
func RegisterLinkQueryServiceServer(s grpc.ServiceRegistrar, srv LinkQueryServiceServer) {
	// If the following call panics, it indicates UnimplementedLinkQueryServiceServer was
