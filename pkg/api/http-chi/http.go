...
func (api *API) Add(w http.ResponseWriter, r *http.Request) {
	...
	go notify.Publish(r.Context(), api_type.METHOD_ADD, newLink, responseCh, "RESPONSE_STORE_ADD")
...
func (api *API) Get(w http.ResponseWriter, r *http.Request) {
	...
	go notify.Publish(r.Context(), api_type.METHOD_GET, request.Hash, responseCh, "RESPONSE_STORE_GET")
...
func (api *API) List(w http.ResponseWriter, r *http.Request) {
	...
	go notify.Publish(r.Context(), api_type.METHOD_LIST, nil, responseCh, "RESPONSE_STORE_LIST")
...
func (api *API) Delete(w http.ResponseWriter, r *http.Request) {
	...
	go notify.Publish(r.Context(), api_type.METHOD_DELETE, request.Hash, responseCh, "RESPONSE_STORE_DELETE")
