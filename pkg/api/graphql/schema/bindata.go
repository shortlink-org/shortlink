...
func linkGraphqls() (*asset, error) {
	...
	info := bindataFileInfo{name: "link.graphqls", size: 387, mode: os.FileMode(420), modTime: time.Unix(1574865622, 0)}
...
func queryGraphqls() (*asset, error) {
	...
	info := bindataFileInfo{name: "query.graphqls", size: 364, mode: os.FileMode(420), modTime: time.Unix(1574765323, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
