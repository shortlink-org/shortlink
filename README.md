...
| API Boundary          | ws               | Websocket service                                                   | Go                 | [docs](./internal/services/ws/README.md)              | [![App Status](https://shortlink.best/argo/cd/api/badge?name=shortlink-ws&revision=true)                                                                            |
...
| Notification Boundary | bot              | Telegram bot                                                        | JAVA               | [docs](./internal/services/bot/README.md)             | [![App Status](https://shortlink.best/argo/cd/api/badge?name=shortlink-bot&revision=true)](https://shortlink.best/argo/cd/applications/shortlink-bot)               |                                                                    
